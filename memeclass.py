...
class MemeClassifier:
    def __init__(self, meme_dname):
        ...
        self._spatial_sim_top_thresh = 0.0
        self._spatial_sim_bottom_thresh = 0.0
    ...
    def _calc_all_hist_inter(self, rgba1, rgba2):        
        ...
        sat1_hist = self._calc_hist(sat1, 255)
        sat2_hist = self._calc_hist(sat2, 255)
        ...
        sat_hist_inter = self._calc_one_hist_inter(sat1_hist, sat2_hist)
